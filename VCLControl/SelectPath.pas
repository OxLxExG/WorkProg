...
procedure TSelectPathFrm.ClearTree;
 var
  pv: PVirtualNode;
begin
...
procedure TSelectPathFrm.Execute(const FileName: string; CheckEvent: TCheckEvent);
...
procedure TSelectPathFrm.TreeChecked(Sender: TBaseVirtualTree; Node: PVirtualNode);
begin
...
procedure TSelectPathFrm.TreeGetNodeDataSize(Sender: TBaseVirtualTree; var NodeDataSize: Integer);
begin
  NodeDataSize := SizeOf(TNodeExData);
end;

procedure TSelectPathFrm.TreeGetText(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex; TextType: TVSTTextType;  var CellText: string);
begin
