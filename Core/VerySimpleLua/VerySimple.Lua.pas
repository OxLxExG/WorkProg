...
type
  ...
  TVerySimpleLua = class(TInterfacedObject)
  private
...
type
  TLuaProc = function(L: Lua_State): Integer; cdecl; //of object; static; // Lua Function
...
begin
 ...
 // Routine.Data := lua_topointer(L, lua_upvalueindex(1));
  ...
  Result := TLuaProc(Routine.Code)(L);
end;
